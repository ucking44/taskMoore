...
<script src="{{ asset('asset/dist/js/material-dashboard.js?v=2.1.2') }}" type="text/javascript"></script>
<script src="{{ asset('asset/dist/js/material.min.js') }}" type="text/javascript"></script>
